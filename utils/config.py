...
EDGE_WORDS_URL = os.getenv('EDGE_WORDS_URL', 'http://127.0.0.1:8000/process_words')
E2B_URL = os.getenv('E2B_URL', '')
...
def load_env():
    ...
    return {
        ...
        'LLM_API_URL': os.getenv('LLM_API_URL', 'https://router.huggingface.co/hf-inference/models'),
